...
export function CalendarPicker({ onClose, onSelectDate }: Props) {
 ...
 return (
  <>
   ...
   <div className="absolute inset-x-4 top-1/2 z-[70] -translate-y-1/2 rounded-3xl bg-white p-5 ">
    {/* Header */}
    <div className="mb-4 flex items-center justify-between">
     ...
     <div className="flex items-center gap-3">
      ...
      <div className="relative">
       ...
       {showYearPicker && (
        <div className="absolute right-0 top-full z-10 mt-1 max-h-40 w-20 overflow-y-auto rounded-xl border border-gray-100 bg-white ">
         {years.map((y) => (
          <button
           key={y}
