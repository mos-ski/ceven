  ...
  return (
    <section className="bg-[#F5EFE4] px-4 sm:px-8 lg:px-16 pt-10 sm:pt-12 pb-16 sm:pb-20">
      <div className="max-w-6xl mx-auto">
        <FadeUp>
          <h2 className="font-[family-name:var(--font-merriweather-import)] font-bold text-[#3B2513] text-4xl mb-8">
            We&apos;ve achieved
          </h2>
        </FadeUp>
              ...
              {STATS.map((stat) => (
                <div key={stat.label} className="flex flex-col items-center gap-6">
                  <CountUp
                    to={stat.to}
                    suffix={stat.suffix}
                    className="font-[family-name:var(--font-merriweather-import)] font-bold text-[#3B2513] text-[64px] sm:text-[80px] lg:text-[100px] leading-none"
                  />
