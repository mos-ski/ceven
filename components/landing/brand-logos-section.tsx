    ...
    <section className="bg-white border-t border-[#E8DFD0] py-10">
      <FadeUp>
        <div className="px-4 sm:px-8 lg:px-16 max-w-6xl mx-auto flex flex-col items-center gap-7">
          <p className="text-[#3b2513]/50 text-sm font-[family-name:var(--font-plus-jakarta-sans)] text-center">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
            {BRANDS.map((brand) => (
              <span
                key={brand}
                className="text-[#3b2513]/30 font-[family-name:var(--font-plus-jakarta-sans)] font-semibold text-sm tracking-wide uppercase select-none"
              >
                {brand}
              </span>
            ))}
