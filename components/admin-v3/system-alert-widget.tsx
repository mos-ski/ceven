  ...
  <div className="fixed bottom-4 right-4 z-40 lg:bottom-6 lg:right-6">
   {collapsed ? (
    <button
     ...
     className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#1E2D4A] to-[#2D1810] text-[#F5EDD8] transition-transform hover:scale-105"
    ...
    <div className="w-[280px] overflow-hidden rounded-2xl bg-gradient-to-br from-[#1E2D4A] to-[#2D1810]">
