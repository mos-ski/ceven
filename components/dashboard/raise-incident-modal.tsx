...
export default function RaiseIncidentModal({ onClose }: Props) {
 ...
 return (
  ...
  >
   <div className="relative flex max-h-[90vh] w-full max-w-full mx-2 sm:mx-4 sm:max-w-[680px] flex-col overflow-hidden rounded-2xl border-6 border-[#faf2e1] bg-white ">
    {/* Header */}
