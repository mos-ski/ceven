            ...
            <tbody className="divide-y divide-[#eaecf0]">
              {GENERATED_REPORTS.map((r) => (
                <tr key={r.id} className="hover:bg-[#faf9f7]">
                  ...
                  <td className="px-4 py-3 font-[family-name:var(--font-urbanist)] text-sm text-[#454b54]">{r.type}</td>
                  <td className="px-4 py-3 font-[family-name:var(--font-urbanist)] text-sm text-[#454b54]">{r.fileType}</td>
                  <td className="px-4 py-3 font-[family-name:var(--font-urbanist)] text-sm text-[#454b54]">{r.generatedOn}</td>
                  <td className="px-4 py-3 font-[family-name:var(--font-urbanist)] text-sm text-[#454b54]">{r.generatedBy}</td>
                  <td className="px-4 py-3">
          ...
          {GENERATED_REPORTS.map((r) => (
            <div key={r.id} className="rounded-xl border border-[#eaecf0] p-3">
              <div className="flex items-center justify-between">
                <p className="text-sm font-bold font-[family-name:var(--font-urbanist)] text-[#2d1810]">{r.title}</p>
                <span className={`inline-flex items-center rounded-full border px-2.5 py-0.5 font-[family-name:var(--font-urbanist)] text-xs ${STATUS_BADGE_CLASS[r.status]}`}>
                  {r.status}
                </span>
              </div>
