...
export function StatCard({ label, value, trendLabel, trendUp }: StatCardProps) {
 return (
  <div className="min-w-0 flex-1 rounded-xl border border-black/[0.07] bg-white p-3 sm:p-4">
   <p className="font-[family-name:var(--font-urbanist)] text-xs text-muted-text sm:text-sm">
    {label}
   </p>
   ...
   <p
    className={cn(
     "mt-2 flex items-center gap-1 font-[family-name:var(--font-urbanist)] text-[10px]",
