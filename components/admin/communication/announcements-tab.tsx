   ...
   <div className="flex flex-col gap-3">
    {ANNOUNCEMENT_LOG.map((a) => (
     <div key={a.id} className="flex flex-col gap-2 rounded-lg bg-[#F5EDD8]/30 p-4">
      ...
      <p className="font-[family-name:var(--font-urbanist)] text-xs text-[#6b7280]">{a.excerpt}</p>
      <div className="flex items-center gap-4">
       <span className="flex items-center gap-1 font-[family-name:var(--font-urbanist)] text-xs font-medium text-black">
  ...
  <div className="flex flex-1 flex-col gap-6 rounded-xl bg-white p-5">
   ...
   <div className="flex flex-col gap-4">
    <div className="flex flex-col gap-1">
     <label className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">Audience</label>
     <select
      defaultValue=""
      className="h-[52px] rounded-xl border border-[#e6ebf3] px-4 font-[family-name:var(--font-urbanist)] text-sm text-[#111] outline-none focus:ring-2 focus:ring-[#c47b2c]"
     >
    ...
    <div className="flex flex-col gap-1">
     <label className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">Type</label>
     <select
    ...
    <div className="flex flex-col gap-1">
     <label className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">Subject</label>
     <input
      placeholder="Enter subject"
      className="h-[52px] rounded-xl border border-[#e6ebf3] px-4 font-[family-name:var(--font-urbanist)] text-sm text-[#111] outline-none placeholder:text-[#9ca3af] focus:ring-2 focus:ring-[#c47b2c]"
     />
    </div>
    <div className="flex flex-col gap-4">
     <div className="flex flex-col gap-1">
      <label className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">Message</label>
      <textarea
       rows={5}
       value={message}
       onChange={(e) => setMessage(e.target.value)}
       placeholder="Type message here.."
       className="resize-none rounded-xl border border-[#e6ebf3] px-4 py-3.5 font-[family-name:var(--font-urbanist)] text-sm text-[#2d1810] outline-none placeholder:text-[#6b7280] focus:ring-2 focus:ring-[#c47b2c]"
      />
     </div>
   ...
   <div className="flex flex-col gap-4">
    <p className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">Templates</p>
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
     {ANNOUNCEMENT_TEMPLATES.map((t) => (
      ...
      >
       <p className="font-[family-name:var(--font-urbanist)] text-sm font-medium text-black">{t.label}</p>
       <p className="font-[family-name:var(--font-urbanist)] text-xs text-[#6b7280]">{t.excerpt}</p>
      </button>
     ))}
    </div>
   </div>
