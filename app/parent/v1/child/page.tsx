...
export default function ChildPage() {
 ...
 <div className="relative flex min-h-0 flex-1 flex-col bg-cg-bg">
  ...
  <div className="mb-5 flex items-center justify-between">
   ...
   <Link href="/parent/notifications" className="flex h-10 w-10 items-center justify-center rounded-full bg-white ">
  ...
  <div className="absolute inset-0 z-50 flex items-end bg-black/35">
   <div className="w-full rounded-t-3xl bg-white px-5 pb-6 pt-4 ">
