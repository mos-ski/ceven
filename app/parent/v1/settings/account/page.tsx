...
export default function ManageAccountPage() {
 ...
 {/* Colorful banner */}
 <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-cg-brand to-emerald-600 p-5 text-white ">
  ...
  <Link
  href="/me"
  className="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-white px-4 py-2 text-xs font-bold text-cg-brand active:bg-white/90"
  >
  Go to ceven.app/me
