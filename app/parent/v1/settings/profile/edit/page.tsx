  ...
  <div className="mb-4">
   ...
   <div className="relative">
    <button
     ...
     className="flex w-full items-center justify-between rounded-xl bg-white px-3 py-3 text-sm"
    >
     <span className="text-gray-800">{value}</span>
     <ChevronDown size={16} className="shrink-0 text-gray-500" />
    </button>
    {open && (
     <div className="absolute z-10 mt-1 w-full rounded-xl bg-white border border-gray-100">
      {options.map((opt) => (
       <button
        key={opt}
  ...
  <div className="relative flex flex-1 flex-col overflow-hidden">
   ...
   <div className="flex-1 overflow-y-auto bg-white px-6 py-5">
    <div className="mb-4">
     ...
     <div className="flex items-center rounded-xl bg-white px-3 py-3 border border-gray-100">
      <input
       value={firstName}
