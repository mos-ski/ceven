 ...
 return (
  <div className="relative flex flex-1 flex-col overflow-hidden bg-[#FAFAFA]">
   ...
   <div className="flex flex-1 flex-col overflow-y-auto px-6 pt-14 pb-8">
    ...
    {/* Header */}
    <h1 className="mb-1 text-[22px] font-bold text-gray-800">Stay Connected 😊</h1>
    <p className="mb-7 text-sm text-gray-500">Good to have you back. Let&apos;s get you signed in.</p>

    {/* Tab switcher */}
    <div className="mb-6 rounded-xl bg-[#F4F5F6] p-1">
     <div className="grid grid-cols-2">
      <button className="rounded-lg bg-white py-2 text-sm font-semibold text-cg-brand ">
       Parents
      </button>
      <Link
       href="/caregiver/auth"
    ...
    <div className="mb-6 flex items-center justify-between">
     ...
     <Link href="/parent/auth/forgot-password" className="text-xs font-semibold text-cg-brand">
      Forgot Password
     </Link>
    </div>
    ...
    <p className="text-center text-sm text-gray-500">
     ...
     <Link href="/parent/auth/signup" className="font-semibold text-cg-brand">
      Sign up
     </Link>
    </p>
   </div>
