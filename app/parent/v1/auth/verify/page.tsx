...
export default function ParentVerifyPage() {
  ...
  const [countdown, setCountdown] = useState(606); // 10:06
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden bg-[#FAFAFA]">
      ...
      <div className="flex flex-1 flex-col px-6 pt-14">
        ...
        {/* Header */}
        <h1 className="mb-1 text-[22px] font-bold text-gray-800">Email Verification</h1>
        ...
        <div className="mt-6 px-0">
          <button
            onClick={() => otp.length === 6 && router.push("/parent/home")}
