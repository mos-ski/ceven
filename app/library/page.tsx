       ...
       <ComponentShowcase title="Favicons">
        <div className="flex flex-wrap items-end gap-8">
         <div className="text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-[8px] bg-white border border-border ">
          ...
          <div className="flex flex-wrap gap-4">
           {[
            ...
            <div key={c.name} className="flex flex-col items-center gap-2">
             <div className="size-16 rounded-[8px] border border-border " style={{ backgroundColor: c.value }} />
  ...
  <button className={cn(buttonVariants({ variant }))}>
   {children}
      ...
      <section id="ai-chat" className="mb-26">
       ...
       <ComponentShowcase>
        <div className="mx-auto max-w-sm overflow-hidden rounded-[8px] border border-border bg-[#fffefa] ">
         {/* Header */}
         ...
         <div className="space-y-3 px-4 py-4">
          ...
          <div className="flex justify-start">
           <div className="max-w-[88%]">
            ...
            <div className="rounded-[8px] bg-white px-4 py-4 text-sm text-gray-700 ">
      ...
      <section id="ai-typing" className="mb-26">
       ...
       <ComponentShowcase>
        <div className="flex items-center gap-2">
         <AiSparkleIcon size={14} className="text-brand-dark" />
         <div className="flex items-center gap-2 rounded-[8px] bg-white px-4 py-4 ">
       ...
       <ComponentShowcase title="Locked (Seedling Plan)">
        <div className="group relative inline-flex items-center gap-2">
         ...
         <div className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-2 -translate-x-1/2 opacity-0 transition-opacity group-hover:opacity-100">
          <div className="whitespace-nowrap rounded-[8px] bg-[#2d1810] px-4 py-2 text-[10px] text-white ">
      ...
      <section id="msg-thread-list" className="mb-26">
       ...
       <ComponentShowcase title="Parent Chat List">
        <div className="mx-auto max-w-sm overflow-hidden rounded-[8px] border border-border bg-white ">
         {/* Search */}
      ...
      <section id="msg-1on1" className="mb-26">
       ...
       <ComponentShowcase>
        <div className="mx-auto max-w-sm overflow-hidden rounded-[8px] border border-border bg-[#FFFEFA] ">
         {/* Header */}
         <div className="flex items-center gap-4 bg-[#FAFAFA] px-4 pt-4 pb-3 ">
         ...
         <div className="bg-[#FAFAFA] px-4 pb-4 pt-3 border-t border-gray-100">
          <div className="flex items-center gap-4">
           <div className="flex flex-1 items-center rounded-[8px] bg-white px-4 py-2 ">
      ...
      <section id="msg-group" className="mb-26">
       ...
       <ComponentShowcase>
        <div className="mx-auto max-w-sm overflow-hidden rounded-[8px] border border-border bg-[#FFFEFA] ">
         {/* Header */}
         <div className="flex items-center gap-4 bg-white px-4 pt-4 pb-3 ">
      ...
      <section id="msg-session" className="mb-26">
       ...
       <ComponentShowcase title="Trial Gate Banner">
        <div className="mx-auto max-w-sm">
         <div className="flex items-center gap-2 rounded-[8px] border border-gray-100 bg-white px-4 py-2 ">
