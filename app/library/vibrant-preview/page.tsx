...
function Swatch({ item }: { item: PaletteItem }) {
  return (
    <div className="overflow-hidden rounded-lg border border-[#DCC7AF] bg-[#FFF9F0] shadow-sm">
      <div
...
function ActionTile({ item }: { item: IconCard }) {
  ...
  return (
    <div className={`rounded-lg border ${item.border} ${item.surface} p-4 shadow-sm`}>
  ...
  return (
    <main className="min-h-screen bg-[#F5F0E8] font-[family-name:var(--font-urbanist-import)] text-[#2D1810]">
      <div className="mx-auto flex w-full max-w-7xl flex-col px-5 py-8 sm:px-8 lg:px-10">
        <header className="grid gap-6 rounded-lg border border-[#4A2F18] bg-[#3B2513] p-5 text-[#FFF9F0] shadow-xl lg:grid-cols-[1.2fr_0.8fr] lg:p-8">
        ...
        <Section eyebrow="Notifications" title="Colorful alerts with clean close affordances">
          <div className="grid gap-4 lg:grid-cols-2">
            {alerts.map((alert) => {
              ...
              return (
                <div key={alert.title} className={`rounded-lg border p-4 shadow-sm ${alert.className}`}>
        ...
        <Section eyebrow="Forms" title="Friendly inputs, square selection controls">
          <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-lg border border-[#DCC7AF] bg-[#FFF9F0] p-5 shadow-sm">
            ...
            <div className="rounded-lg border border-[#DCC7AF] bg-[#FFF9F0] p-5 shadow-sm">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-3">
                {["Fed", "Napped", "Picked up"].map((label, index) => (
                  <div key={label} className="flex items-center gap-3 rounded-lg border border-[#DCC7AF] bg-white p-3">
              ...
              <div className="mt-5 inline-flex rounded-lg border border-[#3B2513] bg-white p-1">
        ...
        <Section eyebrow="Parent and caregiver" title="Mobile surfaces with stronger care cues">
          <div className="grid gap-5 lg:grid-cols-[360px_1fr]">
            <div className="rounded-lg border border-[#3B2513] bg-[#3B2513] p-3 shadow-xl">
              <div className="rounded-lg bg-[#FFF9F0] p-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={label} className="flex gap-3 rounded-lg border border-[#E0BFA0] bg-white p-3">
