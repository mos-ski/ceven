...
export default function SettingsPage() {
 ...
 <div className="relative flex flex-1 flex-col bg-cg-bg">
  ...
  {/* Profile section */}
  <div className="mb-6 flex items-center gap-4 rounded-2xl border border-black/[0.07] bg-white p-4 ">
  ...
  <button
   ...
   className="mt-4 flex w-full items-center gap-3 rounded-2xl bg-white px-4 py-4 text-sm font-medium text-red-500 "
  >
   <LogOut size={18} />
   Log Out
  </button>
