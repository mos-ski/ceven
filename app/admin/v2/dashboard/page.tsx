  ...
  <div className="flex min-w-0 flex-1 flex-col gap-4">
   ...
   <div className="relative flex flex-col gap-4 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-7">
    ...
    <button
     ...
     className="shrink-0 rounded-lg bg-[#faf2e1] px-3 py-2 font-[family-name:var(--font-urbanist)] text-xs font-medium text-[#3b2513] hover:bg-white sm:px-5 sm:py-2.5 sm:text-sm"
    >
     Enroll
    </button>
    </div>
