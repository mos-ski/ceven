...
function AIChatPanel({ onClose }: { onClose: () => void }) {
 ...
 return (
  <div className="flex w-full lg:w-[360px] shrink-0 flex-col overflow-hidden rounded-2xl border-l-4 border-[#c47b2c] bg-[#fffcf4] ">
   {/* Header */}
      ...
      <div className="flex items-center gap-3 overflow-x-auto rounded-xl bg-[#faf2e1] px-4 py-3">
       {quickActions.map(({ id, icon: Icon, label, color }) => (
        <button
         ...
         className="flex shrink-0 flex-col items-center gap-1.5 rounded-xl bg-[#F5EDD8]/30 px-4 py-3 hover:shadow-sm"
        >
       ...
       <button
        ...
        className="flex shrink-0 flex-col items-center gap-1.5 rounded-xl bg-[#F5EDD8]/30 px-4 py-3 text-[#3b2513] hover:shadow-sm"
       >
