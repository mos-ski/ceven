...
function FieldLabel({ children }: { children: React.ReactNode }) {
 return (
 <label className="block font-[family-name:var(--font-urbanist)] text-sm font-medium text-[#2d1810] mb-1.5">
  {children}
 </label>
 );
}
...
function ComposeView() {
 ...
 <div className="flex flex-col flex-1 overflow-hidden">
  ...
  <p className="text-sm font-semibold font-[family-name:var(--font-urbanist)] text-[#2d1810] mb-3">
   Templates
  </p>
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
   ...
   >
    <p className="text-sm font-semibold font-[family-name:var(--font-urbanist)] text-[#2d1810]">
    {name}
    </p>
 ...
 <div className="flex flex-col h-full overflow-hidden">
  ...
  {conversation.map((msg, i) =>
   ...
   <div key={i} className="flex items-start gap-2">
    ...
    <div className="rounded-2xl rounded-tl-none bg-[#fdf6e8] border border-[#e0bfa0] px-4 py-3 text-sm font-[family-name:var(--font-urbanist)] text-[#2d1810] max-w-[80%]">
    {msg.text}
    </div>
   </div>
   ) : (
   <div key={i} className="flex justify-end">
    <div className="rounded-2xl rounded-tr-none bg-[#3b2513] text-[#faf2e1] px-4 py-3 text-sm font-[family-name:var(--font-urbanist)] max-w-[80%]">
    {msg.text}
    </div>
   </div>
   )
  ...
  <textarea
   ...
   className="border border-[#e6ebf3] rounded-xl bg-[#f9f8f6] px-3 py-2.5 text-sm w-full focus:outline-none resize-none placeholder:text-[#9ca3af] font-[family-name:var(--font-urbanist)]"
  />
...
function MessagesView() {
 ...
 <>
  ...
  <div className={`${selectedMessage !== null ? "hidden lg:flex" : "flex"} w-full lg:w-[340px] lg:flex-shrink-0 rounded-2xl bg-white flex-col overflow-hidden`}>
   {/* Search + date filter */}
   ...
   {showNoMessages ? (
    ...
    <p className="text-sm text-[#9ca3af] font-[family-name:var(--font-urbanist)]">
     No Message Yet
    </p>
    </div>
   ) : (
    ...
    return (
     ...
     <div className="flex-1 min-w-0">
      ...
      <p className="text-sm font-bold font-[family-name:var(--font-urbanist)] text-[#2d1810] truncate">
       {msg.name}
      </p>
  ...
  <div className={`${selectedMessage !== null ? "flex" : "hidden lg:flex"} flex-1 rounded-2xl bg-white flex-col overflow-hidden`}>
