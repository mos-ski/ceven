...
import { CALENDAR_EVENTS, CHILDREN } from "@/lib/caregivev3/mock-data";
  ...
  <div className="rounded-2xl bg-[#F5EDD8]/30 p-4">
   <div className="flex items-center gap-2 mb-2">
    ...
    <div className="flex-1">
     ...
     <p className="text-[10px] text-gray-400">{event.date} · {event.time}</p>
    </div>
   ...
   <div className="flex items-center gap-2 mb-3">
    ...
    <span className="text-[10px] text-gray-400">{packed}/{total}</span>
   </div>
   ...
   <div className="space-y-1.5 mb-3">
    {event.checklist.map((item) => (
     <button
      ...
      className="flex w-full items-center gap-2.5 rounded-xl bg-[#f4f5f6] px-3 py-2 text-left hover:bg-gray-100 transition-colors"
     >
      <div
...
export default function CaregiverV3CalendarPage() {
