 ...
 return (
  <div className="mx-auto max-w-3xl">
   ...
   <input
    ...
    className="mb-4 w-full rounded-xl border border-gray-100 bg-white px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-cg-brand focus:outline-none"
   />

   {filtered.length > 0 ? (
    <div className="flex flex-col gap-3">
     {filtered.map((txn) => (
      <div key={txn.id} className="rounded-2xl bg-white p-4 ">
